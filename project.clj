(defproject berganzapablo "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "berganzapablo.jar"
  :main berganzapablo.server
  ...
  {:builds {:min
            ...
            {:source-paths ["src/cljs" "src/cljc" "env/dev/cljs"]
             :figwheel {:on-jsload "berganzapablo.core/mount-root"}
             :compiler
             {:main "berganzapablo.dev"
              :asset-path "/js/out"
              :output-to "target/cljsbuild/public/js/app.js"
